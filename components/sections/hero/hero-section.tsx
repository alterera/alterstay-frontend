...
import { HeroMobileTopBar } from "./hero-mobile-top-bar";
...
export function HeroSection({ className }: HeroSectionProps) {
  return (
    ...
    >
      ...
      <Container className="relative flex flex-col items-center justify-center pb-12 pt-4 text-center sm:pb-14 sm:pt-12 lg:pb-16 lg:pt-32">
